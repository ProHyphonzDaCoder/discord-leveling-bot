...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (!valid) return await interaction.editReply("Please enter a valid image URL. It must use HTTP or HTTPS and be a PNG, JPG, or JPEG image. It must not have a `?` or `&` at the end.");
        ...
        try {
            ...
            return await interaction.editReply("Background set!");
        } catch (e) {
            return await interaction.editReply("An error occurred while setting the background.");
            console.error(e);
        }
    }
}
