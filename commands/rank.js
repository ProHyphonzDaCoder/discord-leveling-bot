...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const rankCard = new canvacord.Rank()
            ...
            .setStatus(interaction.guild.members.cache.find(member => member.id == interaction.options.getUser("target").id).presence.status ?? interaction.member.presence.status, true, 1)
            .setCurrentXP(xpInfo)
